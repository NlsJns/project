        <li>Evenementen</li>
        		...
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=4">Markten & Kermissen</a></li>
        		...
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=17">Jazz & Blues</a></li>
        		
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=18">Wereldmuziek</a></li>
        		
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=19">Amusement & Kleinkunst</a></li>
        		
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=20">Klassiek</a></li>
        		
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=21">Andere</a></li>
        		<li>Podium & literatuur</li>
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=23">Theater & Dans</a></li>
        		
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=24">Literatuur & Humor</a></li>
        		<li>Cursussen en lezingen</li>
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=26">Creatief & Kunst</a></li>
        		
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=29">Mens & Maatschappij</a></li>
        		
        		<li class="inli"><a href="?city=<?php echo($city); ?>&category=30">Natuur & Gezondheid</a></li>
